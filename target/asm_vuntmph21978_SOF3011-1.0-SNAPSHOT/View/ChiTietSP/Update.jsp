...
<div class="background-image">
    ...
    <form class="form-group" method="post" action="/Chi-TietSp/update?id=${list.id}">
        ...
        <label>Năm BH</label>
        <input name="namBH" placeholder="Năm Sx" class="form-control" value="${list.namSX}">
        ...
        <button><a href="/Chi-TietSp/hien-thi" class="btn btn-primary">Quay lại</a></button>
