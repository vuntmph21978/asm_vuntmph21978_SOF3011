...
<table class="table">
    ...
    <c:forEach items="${list}" var="l">
        <tr>
            ...
            <td>${l.quocGia}</td>
            <td>
                <a type="button" class="btn btn-primary" href="/cua-hang/detail?id=${l.id}">Detail</a>
                <a type="button" class="btn btn-danger" href="/cua-hang/delete?id=${l.id}">Delete</a>
                <a type="button" class="btn btn-warning" href="/cua-hang/view-update?id=${l.id}">Update</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
