...
<table class="table">
    ...
    <c:forEach items="${list}" var="l">
        <tr>
            ...
            <td>${l.ten}</td>
            <td>
                <a type="button" class="btn btn-primary" href="/dong-san-pham/detail?id=${l.id}">Detail</a>
                <a type="button" class="btn btn-danger" href="/dong-san-pham/delete?id=${l.id}">Delete</a>
                <a type="button" class="btn btn-warning" href="/dong-san-pham/view-update?id=${l.id}">Update</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
