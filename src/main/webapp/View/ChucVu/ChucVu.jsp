...
<a type="button" class="btn btn-primary" href="/chuc-vu/add">Add</a>
<table class="table">
    <thead>
    <td>Id</td>
    <td>Ma</td>
    ...
    <c:forEach items="${list}" var="l">
        <tr>
            ...
            <td>${l.ten}</td>
            <td>
                <a type="button" class="btn btn-primary" href="/chuc-vu/detail?id=${l.id}">Detail</a>
                <a type="button" class="btn btn-danger" href="/chuc-vu/delete?id=${l.id}">Delete</a>
                <a type="button" class="btn btn-warning" href="/chuc-vu/view-update?id=${l.id}">Update</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
